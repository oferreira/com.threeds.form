        ...
        Threeds._locale = {
            ...
            'fr': {
                'error': {
                    ...
                    'email_invalid': 'L\'adresse email entrer est invalide',
                    'checkbox_require': 'S\'il vous plaît merci de sélectionner la case à cocher'
                }
            }
        };
    })(Threeds = Com.Threeds || (Com.Threeds = {}));
    ...
    (function (Threeds) {
        ...
        (function (Component) {
            ...
            (function (Form) {
                ...
                (function (Element) {
                    var AbstractPolymerElement = Com.Threeds.Element.AbstractPolymerElement;
                    var FieldGroup = Com.Threeds.Component.Form.Element.FieldGroup;
                    var Field = function (_super) {
                        ...
                        Field.prototype.hydrateValidators = function (data) {
                            ...
                            if (typeof data.regex != "undefined") validators.push(new Com.Threeds.Validator.Regex(data));
                    ...
                    (function (Behavior) {
                        ...
                        (function (Neolane) {
                            var FormBehavior = function (_super) {
                                ...
                                FormBehavior.prototype.getHostName = function (url) {
                                ...
                                FormBehavior.prototype._onChange = function (e, elem) {
                                    ...
                                    if (elem.name == 'company' && $('#company').val() != undefined && $('#country').val() != undefined && elem.autoComplete == undefined) {
                                        var apiUrl_1 = location.protocol + '//' + this.getHostName(this.context.settings.api.url) + '/dsx/dnbWebservice.jssp';
    ...
    (function (Threeds) {
        ...
        (function (Component) {
            ...
            (function (Tabs_1) {
                ...
                (function (Element) {
                    var AbstractPolymerElement = Com.Threeds.Element.AbstractPolymerElement;
                    var Tab = Com.Threeds.Component.Tabs.Element.Tab;
            ...
            (function (LandingPage) {
                ...
                (function (Element) {
                    ...
                    (function (Error_1) {
                        ...
                        Error_1.Error = Error;
                    })(Error = Element.Error || (Element.Error = {}));
                })(Element = LandingPage.Element || (LandingPage.Element = {}));
            })(LandingPage = Component.LandingPage || (Component.LandingPage = {}));
        })(Component = Threeds.Component || (Threeds.Component = {}));
    })(Threeds = Com.Threeds || (Com.Threeds = {}));
        ...
        (function (Component) {
            ...
            (function (LandingPage_1) {
                ...
                (function (Element) {
                    ...
                    var Form = Com.Threeds.Component.Form.Element.Form;
                    var Step = Com.Threeds.Component.Form.Element.Step;
                    var Success = Com.Threeds.Component.LandingPage.Element.Success.Success;
                    var Error = Com.Threeds.Component.LandingPage.Element.Error.Error;
                    var TagManager = Com.Threeds.Analytics.TagManager;
...
Com.Threeds.Component.LandingPage.Element.Success.Contact.register();});})(jQuery, window, Drupal);